...
#define read_uint32_bits(start,size) \
    ...
    const ItemType& getStackableItemType(const std::array<std::uint8_t, 4>& strcode)
    {
        static const std::map<std::string, ItemType> stackableBases = {
            ...
            {"rps", {"Small Red Potion", {{ 0, 0 }, false, false, { 0, 0 }}, {0, 0}, {1, 1}, true, "invrps", 0, {"Healing Potion", "Potion", "Miscellaneous", "Unused"}}},
            {"rpl", {"Large Red Potion", {{ 0, 0 }, false, false, { 0, 0 }}, {0, 0}, {1, 1}, true, "invrpl", 0, {"Healing Potion", "Potion", "Miscellaneous", "Unused"}}},
            {"bps", {"Small Blue Potion", {{ 0, 0 }, false, false, { 0, 0 }}, {0, 0}, {1, 1}, true, "invbps", 0, {"Mana Potion", "Potion", "Miscellaneous", "Unused"}}},
            {"bpl", {"Large Blue Potion", {{ 0, 0 }, false, false, { 0, 0 }}, {0, 0}, {1, 1}, true, "invbpl", 0, {"Mana Potion", "Potion", "Miscellaneous", "Unused"}}},
        };
    ...
    {
        static const std::map<std::string, ItemType> miscBases = {
            {"ice", {"Potion of Thawing", {{ 0, 0 }, false, false, { 0, 0 }}, {0, 0}, {1, 1}, false, "invxyz", 0, {"Quest"}}},
            {"0sc", {"Scroll of Knowledge", {{ 0, 0 }, false, false, { 0, 0 }}, {0, 0}, {1, 1}, false, "invrsc", 0, {"Scroll", "Miscellaneous", "Unused"}}},
            {"amu", {"Amulet", {{ 0, 0 }, false, false, { 0, 0 }}, {0, 0}, {1, 1}, false, "invamu", 0, {"Amulet", "Miscellaneous"}}},
            {"tch", {"Torch", {{ 0, 0 }, false, false, { 0, 0 }}, {0, 0}, {1, 2}, false, "invtrch", 0, {"Torch", "Miscellaneous", "Unused"}}},
            {"std", {"Standard of Heroes", {{ 0, 0 }, false, false, { 0, 0 }}, {0, 0, 90}, {1, 1}, false, "invflg", 0, {"Quest"}}},
            ...
            {"hrb", {"Herb", {{ 0, 0 }, false, false, { 0, 0 }}, {0, 0}, {1, 1}, false, "invhrb", 0, {"Herb", "Miscellaneous", "Unused"}}},
            ...
            {"hrt", {"Skeleton Heart", {{ 0, 0 }, false, false, { 0, 0 }}, {0, 0}, {1, 1}, false, "invhrt", 0, {"Miscellaneous", "Unused"}}},
            {"eyz", {"Skeleton Eye", {{ 0, 0 }, false, false, { 0, 0 }}, {0, 0}, {1, 1}, false, "inveye", 0, {"Miscellaneous", "Unused"}}},
            {"brz", {"Skeleton Brain", {{ 0, 0 }, false, false, { 0, 0 }}, {0, 0}, {1, 1}, false, "invbrnz", 0, {"Miscellaneous", "Unused"}}},
            {"hrn", {"Skeleton Horn", {{ 0, 0 }, false, false, { 0, 0 }}, {0, 0}, {1, 1}, false, "invhrn", 0, {"Miscellaneous", "Unused"}}},
            {"fng", {"Skeleton Fang", {{0, 0}, false, false, {0, 0}}, {0, 0}, {1, 1}, false, "invfng", 0, {"Miscellaneous", "Unused"}}},
            {"jaw", {"Skeleton Jawbone", {{0, 0}, false, false, {0, 0}}, {0, 0}, {1, 1}, false, "invjaw", 0, {"Miscellaneous", "Unused"}}},
            {"tal", {"Skeleton Tail", {{0, 0}, false, false, {0, 0}}, {0, 0}, {1, 1}, false, "invtal", 0, {"Miscellaneous", "Unused"}}},
            {"flg", {"Skeleton Flag", {{0, 0}, false, false, {0, 0}}, {0, 0}, {1, 1}, false, "invflg", 0, {"Miscellaneous", "Unused"}}},
            {"qll", {"Skeleton Quill", {{0, 0}, false, false, {0, 0}}, {0, 0}, {1, 1}, false, "invqll", 0, {"Miscellaneous", "Unused"}}},
            {"sol", {"Skeleton Soul", {{0, 0}, false, false, {0, 0}}, {0, 0}, {1, 1}, false, "invsol", 0, {"Miscellaneous", "Unused"}}},
            {"spe", {"Skeleton Spleen", {{0, 0}, false, false, {0, 0}}, {0, 0}, {1, 1}, false, "invspe", 0, {"Miscellaneous", "Unused"}}},
            {"scz", {"Skeleton Scalp", {{0, 0}, false, false, {0, 0}}, {0, 0}, {1, 1}, false, "invqll", 0, {"Miscellaneous", "Unused"}}},
        };
        ...
        testStr[1] = (char)strcode[1];
        testStr[2] = (char)strcode[2];
        auto iter = miscBases.find(testStr);
        if (iter != miscBases.end())
        {
            return iter->second;
        }
    ...
    const std::map<int, std::vector<ItemV100Info>> itemV100Info = {
        {0x000, {{'N', 'N', 0x0000, 0x0000, 0x0002, 0x0010, 0x000B,   0,   0, 2}, {'U', 'U', 0x0000, 0x0000, 0x0000, 0x0000, 0x000B,   0,   0, 2}}},
        {0x001, {{'N', 'N', 0x0000, 0x0000, 0x0002, 0x0010, 0x000B,   0,   0, 3}, {'U', 'U', 0x0001, 0x0000, 0x0000, 0x0000, 0x000B,   0,   0, 3}}},
        {0x002, {{'N', 'N', 0x0000, 0x0000, 0x0002, 0x0010, 0x000F,   0,   0, 3}, {'S', 'S', 0x000B, 0x0000, 0x0000, 0x0000, 0x000F,   0,   0, 3}, {'U', 'U', 0x0002, 0x0000, 0x0000, 0x0000, 0x000F,   0,   0, 3}}},
        {0x003, {{'N', 'N', 0x0000, 0x0000, 0x0002, 0x0010, 0x000F,   0,   0, 3}, {'S', 'S', 0x0008, 0x0000, 0x0000, 0x0000, 0x000F,   0,   0, 3}, {'U', 'U', 0x0003, 0x0000, 0x0000, 0x0000, 0x000F,   0,   0, 3}}},
        {0x004, {{'N', 'N', 0x0000, 0x0000, 0x0002, 0x0010, 0x000B,   0,   0, 3}, {'U', 'U', 0x0004, 0x0000, 0x0000, 0x0000, 0x000B,   0,   0, 3}}},
        {0x005, {{'N', 'N', 0x0000, 0x0000, 0x0002, 0x0010, 0x000B,   0,   0, 3}, {'U', 'U', 0x0005, 0x0000, 0x0000, 0x0000, 0x000B,   0,   0, 3}}},
        {0x006, {{'N', 'N', 0x0000, 0x0000, 0x0002, 0x0010, 0x000B,   0,   0, 3}, {'U', 'U', 0x0006, 0x0000, 0x0000, 0x0000, 0x000B,   0,   0, 3}}},
        {0x007, {{'N', 'N', 0x0000, 0x0000, 0x0002, 0x0010, 0x000B,   0,   0, 3}, {'U', 'U', 0x0007, 0x0000, 0x0000, 0x0000, 0x000B,   0,   0, 3}}},
        {0x008, {{'N', 'N', 0x0000, 0x0000, 0x0002, 0x0010, 0x000B,   0,   0, 3}, {'U', 'U', 0x0008, 0x0000, 0x0000, 0x0000, 0x000B,   0,   0, 3}}},
        {0x009, {{'N', 'N', 0x0000, 0x0000, 0x0002, 0x0010, 0x000B,   0,   0, 3}, {'U', 'U', 0x0009, 0x0000, 0x0000, 0x0000, 0x000B,   0,   0, 3}}},
        {0x00A, {{'N', 'N', 0x0000, 0x0000, 0x0020, 0x0100, 0x000B,   0,   0, 0}, {'U', 'U', 0x000A, 0x0000, 0x0000, 0x0000, 0x000B,   0,   0, 0}}},
        {0x00B, {{'N', 'N', 0x0000, 0x0000, 0x0020, 0x0100, 0x000B,   0,   0, 0}, {'U', 'U', 0x000B, 0x0000, 0x0000, 0x0000, 0x000B,   0,   0, 0}}},
        {0x00C, {{'N', 'N', 0x0000, 0x0000, 0x0020, 0x0100, 0x000B,   0,   0, 0}, {'U', 'U', 0x000C, 0x0000, 0x0000, 0x0000, 0x000B,   0,   0, 0}}},
        {0x00D, {{'N', 'N', 0x0000, 0x0000, 0x0020, 0x0100, 0x000F,   0,   0, 0}, {'S', 'S', 0x000A, 0x0000, 0x0000, 0x0000, 0x000F,   0,   0, 0}, {'U', 'U', 0x000D, 0x0000, 0x0000, 0x0000, 0x000F,   0,   0, 0}}},
        {0x00E, {{'N', 'N', 0x0000, 0x0000, 0x0002, 0x0020, 0x000B,   0,   0, 2}, {'U', 'U', 0x000E, 0x0000, 0x0000, 0x0000, 0x000B,   0,   0, 2}}},
        {0x00F, {{'N', 'N', 0x0000, 0x0000, 0x0010, 0x0080, 0x000B,   0,   0, 2}, {'U', 'U', 0x000F, 0x0000, 0x0000, 0x0000, 0x000B,   0,   0, 2}}},
        {0x010, {{'N', 'N', 0x0000, 0x0000, 0x0010, 0x0080, 0x000F,   0,   0, 2}, {'S', 'S', 0x0000, 0x0000, 0x0000, 0x0000, 0x000F,   0,   0, 2}, {'U', 'U', 0x0010, 0x0000, 0x0000, 0x0000, 0x000F,   0,   0, 2}}},
        {0x011, {{'N', 'N', 0x0000, 0x0000, 0x0010, 0x0080, 0x000F,   0,   0, 2}, {'S', 'S', 0x0006, 0x0000, 0x0000, 0x0000, 0x000F,   0,   0, 2}, {'U', 'U', 0x0011, 0x0000, 0x0000, 0x0000, 0x000F,   0,   0, 2}}},
        {0x012, {{'N', 'N', 0x0000, 0x0000, 0x0002, 0x0020, 0x000B,   0,   0, 2}, {'U', 'U', 0x0012, 0x0000, 0x0000, 0x0000, 0x000B,   0,   0, 2}}},
        {0x013, {{'N', 'N', 0x0000, 0x0000, 0x0002, 0x0020, 0x000B,   0,   0, 2}, {'U', 'U', 0x0013, 0x0000, 0x0000, 0x0000, 0x000B,   0,   0, 2}}},
        {0x014, {{'N', 'N', 0x0000, 0x0000, 0x0002, 0x0020, 0x000B,   0,   0, 2}, {'U', 'U', 0x0014, 0x0000, 0x0000, 0x0000, 0x000B,   0,   0, 2}}},
        {0x015, {{'N', 'N', 0x0000, 0x0000, 0x0002, 0x0020, 0x000B,   0,   0, 3}, {'U', 'U', 0x0015, 0x0000, 0x0000, 0x0000, 0x000B,   0,   0, 3}}},
        {0x016, {{'N', 'N', 0x0000, 0x0000, 0x0002, 0x0020, 0x000B,   0,   0, 3}, {'U', 'U', 0x0016, 0x0000, 0x0000, 0x0000, 0x000B,   0,   0, 3}}},
        {0x017, {{'N', 'N', 0x0000, 0x0000, 0x0002, 0x0020, 0x000B,   0,   0, 3}, {'U', 'U', 0x0017, 0x0000, 0x0000, 0x0000, 0x000B,   0,   0, 3}}},
        {0x018, {{'N', 'N', 0x0000, 0x0000, 0x0002, 0x0020, 0x000B,   0,   0, 3}, {'U', 'U', 0x0018, 0x0000, 0x0000, 0x0000, 0x000B,   0,   0, 3}}},
        {0x019, {{'N', 'N', 0x0000, 0x0000, 0x0002, 0x0008, 0x000B,   0,   0, 2}, {'U', 'U', 0x0019, 0x0000, 0x0000, 0x0000, 0x000B,   0,   0, 2}}},
        {0x01A, {{'N', 'N', 0x0000, 0x0000, 0x0002, 0x0008, 0x000B,   0,   0, 2}, {'U', 'U', 0x001A, 0x0000, 0x0000, 0x0000, 0x000B,   0,   0, 2}}},
        {0x01B, {{'N', 'N', 0x0000, 0x0000, 0x0002, 0x0008, 0x000F,   0,   0, 2}, {'S', 'S', 0x000D, 0x0000, 0x0000, 0x0000, 0x000F,   0,   0, 2}, {'U', 'U', 0x001B, 0x0000, 0x0000, 0x0000, 0x000F,   0,   0, 2}}},
        {0x01C, {{'N', 'N', 0x0000, 0x0000, 0x0002, 0x0008, 0x000B,   0,   0, 2}, {'U', 'U', 0x001C, 0x0000, 0x0000, 0x0000, 0x000B,   0,   0, 2}}},
        {0x01D, {{'N', 'N', 0x0000, 0x0000, 0x0002, 0x0008, 0x000B,   0,   0, 3}, {'U', 'U', 0x001D, 0x0000, 0x0000, 0x0000, 0x000B,   0,   0, 3}}},
        {0x01E, {{'N', 'N', 0x0000, 0x0000, 0x0002, 0x0008, 0x000F,   0,   0, 3}, {'S', 'S', 0x0004, 0x0000, 0x0000, 0x0000, 0x000F,   0,   0, 3}, {'U', 'U', 0x001E, 0x0000, 0x0000, 0x0000, 0x000F,   0,   0, 3}}},
        {0x01F, {{'N', 'N', 0x0000, 0x0000, 0x0002, 0x0008, 0x000F,   0,   0, 3}, {'S', 'S', 0x0002, 0x0000, 0x0000, 0x0000, 0x000F,   0,   0, 3}, {'U', 'U', 0x001F, 0x0000, 0x0000, 0x0000, 0x000F,   0,   0, 3}}},
        {0x020, {{'N', 'N', 0x0000, 0x0000, 0x0002, 0x0008, 0x000F,   0,   0, 2}, {'S', 'S', 0x000C, 0x0000, 0x0000, 0x0000, 0x000F,   0,   0, 2}, {'U', 'U', 0x0020, 0x0000, 0x0000, 0x0000, 0x000F,   0,   0, 2}}},
        {0x021, {{'N', 'N', 0x0000, 0x0000, 0x0002, 0x0008, 0x000B,   0,   0, 3}, {'U', 'U', 0x0021, 0x0000, 0x0000, 0x0000, 0x000B,   0,   0, 3}}},
        {0x022, {{'N', 'N', 0x0000, 0x0000, 0x0002, 0x0008, 0x000B,   0,   0, 3}, {'U', 'U', 0x0022, 0x0000, 0x0000, 0x0000, 0x000B,   0,   0, 3}}},
        {0x023, {{'N', 'N', 0x0000, 0x0000, 0x0002, 0x0008, 0x000B,   0,   0, 3}, {'U', 'U', 0x0023, 0x0000, 0x0000, 0x0000, 0x000B,   0,   0, 3}}},
        {0x024, {{'N', 'N', 0x0000, 0x0000, 0x0002, 0x0008, 0x000B,   0,   0, 3}, {'U', 'U', 0x0024, 0x0000, 0x0000, 0x0000, 0x000B,   0,   0, 3}}},
        {0x025, {{'N', 'N', 0x0000, 0x0000, 0x0002, 0x0008, 0x000B,   0,   0, 3}, {'U', 'U', 0x0025, 0x0000, 0x0000, 0x0000, 0x000B,   0,   0, 3}}},
        {0x026, {{'N', 'N', 0x0000, 0x0000, 0x0002, 0x0008, 0x000B,   0,   0, 3}, {'U', 'U', 0x0026, 0x0000, 0x0000, 0x0000, 0x000B,   0,   0, 3}}},
        {0x027, {{'N', 'N', 0x0000, 0x0000, 0x0002, 0x0008, 0x000B,   0,   0, 1}, {'U', 'U', 0x0027, 0x0000, 0x0000, 0x0000, 0x000B,   0,   0, 1}}},
        {0x028, {{'N', 'N', 0x0000, 0x0000, 0x0002, 0x0008, 0x000B,   0,   0, 1}, {'U', 'U', 0x0028, 0x0000, 0x0000, 0x0000, 0x000B,   0,   0, 1}}},
        {0x029, {{'N', 'N', 0x0000, 0x0000, 0x0002, 0x0008, 0x000B,   0,   0, 2}, {'U', 'U', 0x0029, 0x0000, 0x0000, 0x0000, 0x000B,   0,   0, 2}}},
        {0x02A, {{'N', 'N', 0x0000, 0x0000, 0x0002, 0x0008, 0x000B,   0,   0, 1}, {'U', 'U', 0x002A, 0x0000, 0x0000, 0x0000, 0x000B,   0,   0, 1}}},
        {0x02B, {{'N', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0001,   0,   0, 0}}},
        {0x02C, {{'N', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0001,   0,   0, 0}}},
        {0x02D, {{'N', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0001,   0,   0, 0}}},
        {0x02E, {{'N', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0001,   0,   0, 0}}},
        {0x02F, {{'N', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0001,   0,   0, 0}}},
        {0x030, {{'N', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0001,   0,   0, 0}}},
        {0x031, {{'N', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0001,   0,   0, 0}}},
        {0x032, {{'N', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0001,   0,   0, 0}}},
        {0x033, {{'N', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0001,   0,   0, 0}}},
        {0x034, {{'N', 'N', 0x0000, 0x0000, 0x0002, 0x0040, 0x000B,   0,   0, 3}, {'U', 'U', 0x002B, 0x0000, 0x0000, 0x0000, 0x000B,   0,   0, 3}}},
        {0x035, {{'N', 'N', 0x0000, 0x0000, 0x0002, 0x0040, 0x000B,   0,   0, 3}, {'U', 'U', 0x002C, 0x0000, 0x0000, 0x0000, 0x000B,   0,   0, 3}}},
        {0x036, {{'N', 'N', 0x0000, 0x0000, 0x0002, 0x0040, 0x000B,   0,   0, 3}, {'U', 'U', 0x002D, 0x0000, 0x0000, 0x0000, 0x000B,   0,   0, 3}}},
        {0x037, {{'N', 'N', 0x0000, 0x0000, 0x0002, 0x0040, 0x000B,   0,   0, 3}, {'U', 'U', 0x002E, 0x0000, 0x0000, 0x0000, 0x000B,   0,   0, 3}}},
        {0x038, {{'N', 'N', 0x0000, 0x0000, 0x0002, 0x0040, 0x000B,   0,   0, 3}, {'U', 'U', 0x002F, 0x0000, 0x0000, 0x0000, 0x000B,   0,   0, 3}}},
        {0x039, {{'N', 'N', 0x0000, 0x0000, 0x0002, 0x0040, 0x000B,   0,   0, 3}, {'U', 'U', 0x0030, 0x0000, 0x0000, 0x0000, 0x000B,   0,   0, 3}}},
        {0x03A, {{'N', 'N', 0x0000, 0x0000, 0x0002, 0x0040, 0x000B,   0,   0, 3}, {'U', 'U', 0x0031, 0x0000, 0x0000, 0x0000, 0x000B,   0,   0, 3}}},
        {0x03B, {{'N', 'N', 0x0000, 0x0000, 0x0002, 0x0040, 0x000B,   0,   0, 3}, {'U', 'U', 0x0032, 0x0000, 0x0000, 0x0000, 0x000B,   0,   0, 3}}},
        {0x03C, {{'N', 'N', 0x0000, 0x0000, 0x0002, 0x0040, 0x000B,   0,   0, 3}, {'U', 'U', 0x0033, 0x0000, 0x0000, 0x0000, 0x000B,   0,   0, 3}}},
        {0x03D, {{'N', 'N', 0x0000, 0x0000, 0x0002, 0x0040, 0x000B,   0,   0, 3}, {'U', 'U', 0x0034, 0x0000, 0x0000, 0x0000, 0x000B,   0,   0, 3}}},
        {0x03E, {{'N', 'N', 0x0000, 0x0000, 0x0002, 0x0040, 0x000B,   0,   0, 3}, {'U', 'U', 0x0035, 0x0000, 0x0000, 0x0000, 0x000B,   0,   0, 3}}},
        {0x03F, {{'N', 'N', 0x0000, 0x0000, 0x0040, 0x0200, 0x000B,   0,   0, 2}, {'U', 'U', 0x0036, 0x0000, 0x0000, 0x0000, 0x000B,   0,   0, 2}}},
        {0x040, {{'N', 'N', 0x0000, 0x0000, 0x0040, 0x0200, 0x000B,   0,   0, 3}, {'U', 'U', 0x0037, 0x0000, 0x0000, 0x0000, 0x000B,   0,   0, 3}}},
        {0x041, {{'N', 'N', 0x0000, 0x0000, 0x0040, 0x0200, 0x000B,   0,   0, 3}, {'U', 'U', 0x0038, 0x0000, 0x0000, 0x0000, 0x000B,   0,   0, 3}}},
        {0x042, {{'N', 'N', 0x0000, 0x0000, 0x0040, 0x0200, 0x000F,   0,   0, 3}, {'S', 'S', 0x0007, 0x0000, 0x0000, 0x0000, 0x000F,   0,   0, 3}, {'U', 'U', 0x0039, 0x0000, 0x0000, 0x0000, 0x000F,   0,   0, 3}}},
        {0x043, {{'N', 'N', 0x0000, 0x0000, 0x0040, 0x0200, 0x000F,   0,   0, 3}, {'S', 'S', 0x000F, 0x0000, 0x0000, 0x0000, 0x000F,   0,   0, 3}, {'U', 'U', 0x003A, 0x0000, 0x0000, 0x0000, 0x000F,   0,   0, 3}}},
        {0x044, {{'N', 'N', 0x0000, 0x0000, 0x0080, 0x0400, 0x000B,   0,   0, 3}, {'U', 'U', 0x003B, 0x0000, 0x0000, 0x0000, 0x000B,   0,   0, 3}}},
        {0x045, {{'N', 'N', 0x0000, 0x0000, 0x0080, 0x0400, 0x000B,   0,   0, 3}, {'U', 'U', 0x003C, 0x0000, 0x0000, 0x0000, 0x000B,   0,   0, 3}}},
        {0x046, {{'N', 'N', 0x0000, 0x0000, 0x0080, 0x0400, 0x000B,   0,   0, 3}, {'U', 'U', 0x003D, 0x0000, 0x0000, 0x0000, 0x000B,   0,   0, 3}}},
        {0x047, {{'N', 'N', 0x0000, 0x0000, 0x0080, 0x0400, 0x000B,   0,   0, 3}, {'U', 'U', 0x003E, 0x0000, 0x0000, 0x0000, 0x000B,   0,   0, 3}}},
        {0x048, {{'N', 'N', 0x0000, 0x0000, 0x0080, 0x0400, 0x000B,   0,   0, 3}, {'U', 'U', 0x003F, 0x0000, 0x0000, 0x0000, 0x000B,   0,   0, 3}}},
        {0x049, {{'N', 'N', 0x0000, 0x0000, 0x0080, 0x0400, 0x000F,   0,   0, 3}, {'S', 'S', 0x0005, 0x0000, 0x0000, 0x0000, 0x000F,   0,   0, 3}, {'U', 'U', 0x0040, 0x0000, 0x0000, 0x0000, 0x000F,   0,   0, 3}}},
        {0x04A, {{'N', 'N', 0x0000, 0x0000, 0x0080, 0x0400, 0x000F,   0,   0, 3}, {'S', 'S', 0x000E, 0x0000, 0x0000, 0x0000, 0x000F,   0,   0, 3}, {'U', 'U', 0x0041, 0x0000, 0x0000, 0x0000, 0x000F,   0,   0, 3}}},
        {0x04B, {{'N', 'N', 0x0000, 0x0000, 0x0080, 0x0400, 0x000B,   0,   0, 3}, {'U', 'U', 0x0042, 0x0000, 0x0000, 0x0000, 0x000B,   0,   0, 3}}},
        {0x04C, {{'N', 'N', 0x0000, 0x0000, 0x0080, 0x0400, 0x000B,   0,   0, 3}, {'U', 'U', 0x0043, 0x0000, 0x0000, 0x0000, 0x000B,   0,   0, 3}}},
        {0x04D, {{'N', 'N', 0x0000, 0x0000, 0x0080, 0x0400, 0x000B,   0,   0, 3}, {'U', 'U', 0x0044, 0x0000, 0x0000, 0x0000, 0x000B,   0,   0, 3}}},
        {0x04E, {{'N', 'N', 0x0000, 0x0000, 0x0080, 0x0400, 0x000B,   0,   0, 3}, {'U', 'U', 0x0045, 0x0000, 0x0000, 0x0000, 0x000B,   0,   0, 3}}},
        {0x04F, {{'N', 'N', 0x0000, 0x0000, 0x0080, 0x0400, 0x000B,   0,   0, 3}, {'U', 'U', 0x0046, 0x0000, 0x0000, 0x0000, 0x000B,   0,   0, 3}}},
        {0x050, {{'N', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0001,   0,   0, 0}}},
        {0x051, {{'N', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0001,   0,   0, 0}}},
        {0x052, {{'N', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0001,   0,   0, 0}}},
        {0x053, {{'N', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0001,   0,   0, 0}}},
        {0x054, {{'N', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0001,   0,   0, 0}}},
        {0x055, {{'N', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0001,   0,   0, 0}}},
        {0x056, {{'Q', 'N', 0x0000, 0x0000, 0x0002, 0x0008, 0x0003,   0,   0, 0}}},
        {0x057, {{'Q', 'N', 0x0000, 0x0000, 0x0002, 0x0008, 0x0003,   0,   0, 0}}},
        {0x058, {{'Q', 'N', 0x0000, 0x0000, 0x0002, 0x0020, 0x0003,   0,   0, 2}}},
        {0x059, {{'Q', 'N', 0x0000, 0x0000, 0x0002, 0x0008, 0x0003,   0,   0, 0}}},
        {0x05A, {{'U', 'U', 0x007E, 0x0000, 0x0002, 0x0010, 0x0008,   0,   0, 0}}},
        {0x05B, {{'U', 'U', 0x007D, 0x0000, 0x0040, 0x0200, 0x0008,   0,   0, 0}}},
        {0x05C, {{'U', 'U', 0x007C, 0x0000, 0x0040, 0x0200, 0x0008,   0,   0, 0}}},
        {0x05D, {{'E', 'N', 0x0000, 0x0000, 0x0002, 0x0010, 0x0003,   0,   0, 2}}},
        {0x05E, {{'E', 'N', 0x0000, 0x0000, 0x0002, 0x0010, 0x0003,   0,   0, 3}}},
        {0x05F, {{'E', 'N', 0x0000, 0x0000, 0x0002, 0x0010, 0x0003,   0,   0, 3}}},
        {0x060, {{'E', 'N', 0x0000, 0x0000, 0x0002, 0x0010, 0x0003,   0,   0, 3}}},
        {0x061, {{'E', 'N', 0x0000, 0x0000, 0x0002, 0x0010, 0x0003,   0,   0, 3}}},
        {0x062, {{'E', 'N', 0x0000, 0x0000, 0x0002, 0x0010, 0x0003,   0,   0, 3}}},
        {0x063, {{'E', 'N', 0x0000, 0x0000, 0x0002, 0x0010, 0x0003,   0,   0, 3}}},
        {0x064, {{'E', 'N', 0x0000, 0x0000, 0x0002, 0x0010, 0x0003,   0,   0, 3}}},
        {0x065, {{'E', 'N', 0x0000, 0x0000, 0x0002, 0x0010, 0x0003,   0,   0, 3}}},
        {0x066, {{'E', 'N', 0x0000, 0x0000, 0x0002, 0x0010, 0x0003,   0,   0, 3}}},
        {0x067, {{'E', 'N', 0x0000, 0x0000, 0x0020, 0x0100, 0x0003,   0,   0, 0}}},
        {0x068, {{'E', 'N', 0x0000, 0x0000, 0x0020, 0x0100, 0x0003,   0,   0, 0}}},
        {0x069, {{'E', 'N', 0x0000, 0x0000, 0x0020, 0x0100, 0x0003,   0,   0, 0}}},
        {0x06A, {{'E', 'N', 0x0000, 0x0000, 0x0020, 0x0100, 0x0003,   0,   0, 0}}},
        {0x06B, {{'E', 'N', 0x0000, 0x0000, 0x0002, 0x0020, 0x0003,   0,   0, 2}}},
        {0x06C, {{'E', 'N', 0x0000, 0x0000, 0x0010, 0x0080, 0x0003,   0,   0, 2}}},
        {0x06D, {{'E', 'N', 0x0000, 0x0000, 0x0010, 0x0080, 0x0003,   0,   0, 2}}},
        {0x06E, {{'E', 'N', 0x0000, 0x0000, 0x0010, 0x0080, 0x0003,   0,   0, 2}}},
        {0x06F, {{'E', 'N', 0x0000, 0x0000, 0x0002, 0x0020, 0x0003,   0,   0, 2}}},
        {0x070, {{'E', 'N', 0x0000, 0x0000, 0x0002, 0x0020, 0x0003,   0,   0, 2}}},
        {0x071, {{'E', 'N', 0x0000, 0x0000, 0x0002, 0x0020, 0x0003,   0,   0, 2}}},
        {0x072, {{'E', 'N', 0x0000, 0x0000, 0x0002, 0x0020, 0x0003,   0,   0, 3}}},
        {0x073, {{'E', 'N', 0x0000, 0x0000, 0x0002, 0x0020, 0x0003,   0,   0, 3}}},
        {0x074, {{'E', 'N', 0x0000, 0x0000, 0x0002, 0x0020, 0x0003,   0,   0, 3}}},
        {0x075, {{'E', 'N', 0x0000, 0x0000, 0x0002, 0x0020, 0x0003,   0,   0, 3}}},
        {0x076, {{'E', 'N', 0x0000, 0x0000, 0x0002, 0x0008, 0x0003,   0,   0, 2}}},
        {0x077, {{'E', 'N', 0x0000, 0x0000, 0x0002, 0x0008, 0x0003,   0,   0, 2}}},
        {0x078, {{'E', 'N', 0x0000, 0x0000, 0x0002, 0x0008, 0x0003,   0,   0, 2}}},
        {0x079, {{'E', 'N', 0x0000, 0x0000, 0x0002, 0x0008, 0x0003,   0,   0, 2}}},
        {0x07A, {{'E', 'N', 0x0000, 0x0000, 0x0002, 0x0008, 0x0003,   0,   0, 3}}},
        {0x07B, {{'E', 'N', 0x0000, 0x0000, 0x0002, 0x0008, 0x0003,   0,   0, 3}}},
        {0x07C, {{'E', 'N', 0x0000, 0x0000, 0x0002, 0x0008, 0x0003,   0,   0, 3}}},
        {0x07D, {{'E', 'N', 0x0000, 0x0000, 0x0002, 0x0008, 0x0003,   0,   0, 2}}},
        {0x07E, {{'E', 'N', 0x0000, 0x0000, 0x0002, 0x0008, 0x0003,   0,   0, 3}}},
        {0x07F, {{'E', 'N', 0x0000, 0x0000, 0x0002, 0x0008, 0x0003,   0,   0, 3}}},
        {0x080, {{'E', 'N', 0x0000, 0x0000, 0x0002, 0x0008, 0x0003,   0,   0, 3}}},
        {0x081, {{'E', 'N', 0x0000, 0x0000, 0x0002, 0x0008, 0x0003,   0,   0, 3}}},
        {0x082, {{'E', 'N', 0x0000, 0x0000, 0x0002, 0x0008, 0x0003,   0,   0, 3}}},
        {0x083, {{'E', 'N', 0x0000, 0x0000, 0x0002, 0x0008, 0x0003,   0,   0, 3}}},
        {0x084, {{'E', 'N', 0x0000, 0x0000, 0x0002, 0x0008, 0x0003,   0,   0, 1}}},
        {0x085, {{'E', 'N', 0x0000, 0x0000, 0x0002, 0x0008, 0x0003,   0,   0, 1}}},
        {0x086, {{'E', 'N', 0x0000, 0x0000, 0x0002, 0x0008, 0x0003,   0,   0, 2}}},
        {0x087, {{'E', 'N', 0x0000, 0x0000, 0x0002, 0x0008, 0x0003,   0,   0, 1}}},
        {0x088, {{'E', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0001,   0,   0, 0}}},
        {0x089, {{'E', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0001,   0,   0, 0}}},
        {0x08A, {{'E', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0001,   0,   0, 0}}},
        {0x08B, {{'E', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0001,   0,   0, 0}}},
        {0x08C, {{'E', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0001,   0,   0, 0}}},
        {0x08D, {{'E', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0001,   0,   0, 0}}},
        {0x08E, {{'E', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0001,   0,   0, 0}}},
        {0x08F, {{'E', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0001,   0,   0, 0}}},
        {0x090, {{'E', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0001,   0,   0, 0}}},
        {0x091, {{'E', 'N', 0x0000, 0x0000, 0x0002, 0x0040, 0x0001,   0,   0, 3}}},
        {0x092, {{'E', 'N', 0x0000, 0x0000, 0x0002, 0x0040, 0x0003,   0,   0, 3}}},
        {0x093, {{'E', 'N', 0x0000, 0x0000, 0x0002, 0x0040, 0x0003,   0,   0, 3}}},
        {0x094, {{'E', 'N', 0x0000, 0x0000, 0x0002, 0x0040, 0x0003,   0,   0, 3}}},
        {0x095, {{'E', 'N', 0x0000, 0x0000, 0x0002, 0x0040, 0x0003,   0,   0, 3}}},
        {0x096, {{'E', 'N', 0x0000, 0x0000, 0x0002, 0x0040, 0x0003,   0,   0, 3}}},
        {0x097, {{'E', 'N', 0x0000, 0x0000, 0x0002, 0x0040, 0x0003,   0,   0, 3}}},
        {0x098, {{'E', 'N', 0x0000, 0x0000, 0x0002, 0x0040, 0x0003,   0,   0, 3}}},
        {0x099, {{'E', 'N', 0x0000, 0x0000, 0x0002, 0x0040, 0x0003,   0,   0, 3}}},
        {0x09A, {{'E', 'N', 0x0000, 0x0000, 0x0002, 0x0040, 0x0003,   0,   0, 3}}},
        {0x09B, {{'E', 'N', 0x0000, 0x0000, 0x0002, 0x0040, 0x0003,   0,   0, 3}}},
        {0x09C, {{'E', 'N', 0x0000, 0x0000, 0x0040, 0x0200, 0x0003,   0,   0, 2}}},
        {0x09D, {{'E', 'N', 0x0000, 0x0000, 0x0040, 0x0200, 0x0003,   0,   0, 3}}},
        {0x09E, {{'E', 'N', 0x0000, 0x0000, 0x0040, 0x0200, 0x0003,   0,   0, 3}}},
        {0x09F, {{'E', 'N', 0x0000, 0x0000, 0x0040, 0x0200, 0x0003,   0,   0, 3}}},
        {0x0A0, {{'E', 'N', 0x0000, 0x0000, 0x0040, 0x0200, 0x0003,   0,   0, 3}}},
        {0x0A1, {{'E', 'N', 0x0000, 0x0000, 0x0080, 0x0400, 0x0003,   0,   0, 3}}},
        {0x0A2, {{'E', 'N', 0x0000, 0x0000, 0x0080, 0x0400, 0x0003,   0,   0, 3}}},
        {0x0A3, {{'E', 'N', 0x0000, 0x0000, 0x0080, 0x0400, 0x0003,   0,   0, 3}}},
        {0x0A4, {{'E', 'N', 0x0000, 0x0000, 0x0080, 0x0400, 0x0003,   0,   0, 3}}},
        {0x0A5, {{'E', 'N', 0x0000, 0x0000, 0x0080, 0x0400, 0x0003,   0,   0, 3}}},
        {0x0A6, {{'E', 'N', 0x0000, 0x0000, 0x0080, 0x0400, 0x0003,   0,   0, 3}}},
        {0x0A7, {{'E', 'N', 0x0000, 0x0000, 0x0080, 0x0400, 0x0003,   0,   0, 3}}},
        {0x0A8, {{'E', 'N', 0x0000, 0x0000, 0x0080, 0x0400, 0x0003,   0,   0, 3}}},
        {0x0A9, {{'E', 'N', 0x0000, 0x0000, 0x0080, 0x0400, 0x0003,   0,   0, 3}}},
        {0x0AA, {{'E', 'N', 0x0000, 0x0000, 0x0080, 0x0400, 0x0003,   0,   0, 3}}},
        {0x0AB, {{'E', 'N', 0x0000, 0x0000, 0x0080, 0x0400, 0x0003,   0,   0, 3}}},
        {0x0AC, {{'E', 'N', 0x0000, 0x0000, 0x0080, 0x0400, 0x0003,   0,   0, 3}}},
        {0x0AD, {{'Q', 'N', 0x0000, 0x0000, 0x0002, 0x0020, 0x0003,   0,   0, 0}}},
        {0x0AE, {{'Q', 'N', 0x0000, 0x0000, 0x0002, 0x0020, 0x0003,   0,   0, 0}}},
        {0x0AF, {{'N', 'N', 0x0000, 0x0000, 0x0001, 0x0002, 0x000F,   3,   5, 2}, {'S', 'S', 0x000A, 0x0000, 0x0000, 0x0000, 0x000F,   3,   5, 2}, {'U', 'U', 0x0047, 0x0000, 0x0000, 0x0000, 0x000F,   3,   5, 2}}},
        {0x0B0, {{'N', 'N', 0x0000, 0x0000, 0x0001, 0x0002, 0x000F,   8,  11, 2}, {'S', 'S', 0x000F, 0x0000, 0x0000, 0x0000, 0x000F,   8,  11, 2}, {'U', 'U', 0x0048, 0x0000, 0x0000, 0x0000, 0x000F,   8,  11, 2}}},
        {0x0B1, {{'N', 'N', 0x0000, 0x0000, 0x0001, 0x0002, 0x000F,  15,  18, 2}, {'S', 'S', 0x000B, 0x0000, 0x0000, 0x0000, 0x000F,  15,  18, 2}, {'U', 'U', 0x0049, 0x0000, 0x0000, 0x0000, 0x000F,  15,  18, 2}}},
        {0x0B2, {{'N', 'N', 0x0000, 0x0000, 0x0001, 0x0002, 0x000F,  23,  26, 2}, {'S', 'S', 0x0004, 0x0000, 0x0000, 0x0000, 0x000F,  23,  26, 2}, {'U', 'U', 0x004A, 0x0000, 0x0000, 0x0000, 0x000F,  23,  26, 2}}},
        {0x0B3, {{'N', 'N', 0x0000, 0x0000, 0x0001, 0x0002, 0x000F,  30,  35, 2}, {'S', 'S', 0x0009, 0x0000, 0x0000, 0x0000, 0x000F,  30,  35, 2}, {'U', 'U', 0x004C, 0x0000, 0x0000, 0x0000, 0x000F,  30,  35, 2}}},
        {0x0B4, {{'N', 'N', 0x0000, 0x0000, 0x0001, 0x0002, 0x000F,  25,  45, 2}, {'S', 'S', 0x0003, 0x0070, 0x0000, 0x0000, 0x000F,  25,  45, 2}, {'S', 'S', 0x0006, 0xFF8F, 0x0000, 0x0000, 0x000F,  25,  45, 2}, {'U', 'U', 0x004D, 0x0000, 0x0000, 0x0000, 0x000F,  25,  45, 2}}},
        {0x0B5, {{'N', 'N', 0x0000, 0x0000, 0x0001, 0x0002, 0x000F,   9,  27, 2}, {'S', 'S', 0x0007, 0x0000, 0x0000, 0x0000, 0x000F,   9,  27, 2}, {'U', 'U', 0x004E, 0x0000, 0x0000, 0x0000, 0x000F,   9,  27, 2}}},
        {0x0B6, {{'N', 'N', 0x0000, 0x0000, 0x0001, 0x0001, 0x000F,   8,  11, 0}, {'S', 'S', 0x000E, 0x0000, 0x0000, 0x0000, 0x000F,   8,  11, 0}, {'U', 'U', 0x004F, 0x0000, 0x0000, 0x0000, 0x000F,   8,  11, 0}}},
        {0x0B7, {{'N', 'N', 0x0000, 0x0000, 0x0001, 0x0001, 0x000F,  14,  17, 0}, {'S', 'S', 0x0005, 0x0000, 0x0000, 0x0000, 0x000F,  14,  17, 0}, {'U', 'U', 0x0050, 0x0000, 0x0000, 0x0000, 0x000F,  14,  17, 0}}},
        {0x0B8, {{'N', 'N', 0x0000, 0x0000, 0x0001, 0x0001, 0x000F,  21,  24, 0}, {'U', 'U', 0x0051, 0x0000, 0x0000, 0x0000, 0x000B,  21,  24, 0}}},
        {0x0B9, {{'N', 'N', 0x0000, 0x0000, 0x0001, 0x0001, 0x000B,  32,  35, 0}, {'U', 'U', 0x0052, 0x0000, 0x0000, 0x0000, 0x000F,  32,  35, 0}}},
        {0x0BA, {{'N', 'N', 0x0000, 0x0000, 0x0001, 0x0001, 0x000F,  45,  48, 0}, {'S', 'S', 0x000D, 0x0000, 0x0000, 0x0000, 0x000F,  45,  48, 0}, {'U', 'U', 0x0053, 0x0000, 0x0000, 0x0000, 0x000F,  45,  48, 0}}},
        {0x0BB, {{'N', 'N', 0x0000, 0x0000, 0x0001, 0x0001, 0x000F,  57,  60, 0}, {'U', 'U', 0x0054, 0x0000, 0x0000, 0x0000, 0x000F,  57,  60, 0}}},
        {0x0BC, {{'N', 'N', 0x0000, 0x0000, 0x0001, 0x0001, 0x000F,  72,  75, 0}, {'S', 'S', 0x0007, 0x0000, 0x0000, 0x0000, 0x000F,  72,  75, 0}, {'U', 'U', 0x0055, 0x0000, 0x0000, 0x0000, 0x000F,  72,  75, 0}}},
        {0x0BD, {{'N', 'N', 0x0000, 0x0000, 0x0001, 0x0001, 0x000F,  65,  68, 0}, {'S', 'S', 0x0004, 0x0000, 0x0000, 0x0000, 0x000F,  65,  68, 0}, {'U', 'U', 0x0056, 0x0000, 0x0000, 0x0000, 0x000F,  65,  68, 0}}},
        {0x0BE, {{'N', 'N', 0x0000, 0x0000, 0x0001, 0x0001, 0x000F,  90,  95, 0}, {'S', 'S', 0x000B, 0x0000, 0x0000, 0x0000, 0x000F,  90,  95, 0}, {'U', 'U', 0x0057, 0x0000, 0x0000, 0x0000, 0x000F,  90,  95, 0}}},
        {0x0BF, {{'N', 'N', 0x0000, 0x0000, 0x0001, 0x0001, 0x000B, 108, 116, 0}, {'U', 'U', 0x0058, 0x0000, 0x0000, 0x0000, 0x000B, 108, 116, 0}}},
        {0x0C0, {{'N', 'N', 0x0000, 0x0000, 0x0001, 0x0001, 0x000B, 101, 105, 0}, {'U', 'U', 0x0059, 0x0000, 0x0000, 0x0000, 0x000B, 101, 105, 0}}},
        {0x0C1, {{'N', 'N', 0x0000, 0x0000, 0x0001, 0x0001, 0x000F, 128, 135, 0}, {'S', 'S', 0x0009, 0x0000, 0x0000, 0x0000, 0x000F, 128, 135, 0}, {'U', 'U', 0x005A, 0x0000, 0x0000, 0x0000, 0x000F, 128, 135, 0}}},
        {0x0C2, {{'N', 'N', 0x0000, 0x0000, 0x0001, 0x0001, 0x000F, 150, 161, 0}, {'S', 'S', 0x0008, 0x0000, 0x0000, 0x0000, 0x000F, 150, 161, 0}, {'U', 'U', 0x005B, 0x0000, 0x0000, 0x0000, 0x000F, 150, 161, 0}}},
        {0x0C3, {{'N', 'N', 0x0000, 0x0000, 0x0001, 0x0001, 0x000F, 218, 233, 0}, {'S', 'S', 0x0006, 0x0000, 0x0000, 0x0000, 0x000F, 218, 233, 0}, {'U', 'U', 0x005C, 0x0000, 0x0000, 0x0000, 0x000F, 218, 233, 0}}},
        {0x0C4, {{'N', 'N', 0x0000, 0x0000, 0x0001, 0x0001, 0x000F,  90, 107, 0}, {'S', 'S', 0x000F, 0x0000, 0x0000, 0x0000, 0x000F,  90, 107, 0}, {'U', 'U', 0x005D, 0x0000, 0x0000, 0x0000, 0x000F,  90, 107, 0}}},
        {0x0C5, {{'N', 'N', 0x0000, 0x0000, 0x0004, 0x0004, 0x000F,   4,   6, 1}, {'S', 'S', 0x0001, 0x0000, 0x0000, 0x0000, 0x000F,   4,   6, 1}, {'U', 'U', 0x005E, 0x0000, 0x0000, 0x0000, 0x000F,   4,   6, 1}}},
        {0x0C6, {{'N', 'N', 0x0000, 0x0000, 0x0004, 0x0004, 0x000F,   8,  10, 2}, {'S', 'S', 0x0002, 0x0000, 0x0000, 0x0000, 0x000F,   8,  10, 2}, {'U', 'U', 0x005F, 0x0000, 0x0000, 0x0000, 0x000F,   8,  10, 2}}},
        {0x0C7, {{'N', 'N', 0x0000, 0x0000, 0x0004, 0x0004, 0x000F,  12,  14, 3}, {'S', 'S', 0x0000, 0x0000, 0x0000, 0x0000, 0x000F,  12,  14, 3}, {'U', 'U', 0x0060, 0x0000, 0x0000, 0x0000, 0x000F,  12,  14, 3}}},
        {0x0C8, {{'N', 'N', 0x0000, 0x0000, 0x0004, 0x0004, 0x000F,  16,  18, 3}, {'S', 'S', 0x0006, 0x0000, 0x0000, 0x0000, 0x000F,  16,  18, 3}, {'U', 'U', 0x0063, 0x0000, 0x0000, 0x0000, 0x000F,  16,  18, 3}}},
        {0x0C9, {{'N', 'N', 0x0000, 0x0000, 0x0004, 0x0004, 0x000F,  22,  25, 3}, {'S', 'S', 0x0009, 0x0000, 0x0000, 0x0000, 0x000F,  22,  25, 3}, {'U', 'U', 0x0064, 0x0000, 0x0000, 0x0000, 0x000F,  22,  25, 3}}},
        {0x0CA, {{'N', 'N', 0x0000, 0x0000, 0x0004, 0x0004, 0x000F,  30,  35, 3}, {'S', 'S', 0x0004, 0x0000, 0x0000, 0x0000, 0x000F,  30,  35, 3}, {'U', 'U', 0x0065, 0x0000, 0x0000, 0x0000, 0x000F,  30,  35, 3}}},
        {0x0CB, {{'N', 'N', 0x0000, 0x0000, 0x0200, 0x1000, 0x000F,   2,   3, 0}, {'S', 'S', 0x000C, 0x0000, 0x0000, 0x0000, 0x000F,   2,   3, 0}, {'U', 'U', 0x0066, 0x0000, 0x0000, 0x0000, 0x000F,   2,   3, 0}}},
        {0x0CC, {{'N', 'N', 0x0000, 0x0000, 0x0200, 0x1000, 0x000B,   5,   6, 0}, {'U', 'U', 0x0067, 0x0000, 0x0000, 0x0000, 0x000B,   5,   6, 0}}},
        {0x0CD, {{'N', 'N', 0x0000, 0x0000, 0x0200, 0x1000, 0x000F,   8,   9, 0}, {'S', 'S', 0x0002, 0x0000, 0x0000, 0x0000, 0x000F,   8,   9, 0}, {'U', 'U', 0x0068, 0x0000, 0x0000, 0x0000, 0x000F,   8,   9, 0}}},
        {0x0CE, {{'N', 'N', 0x0000, 0x0000, 0x0200, 0x1000, 0x000F,   9,  11, 0}, {'S', 'S', 0x0003, 0x7FF0, 0x0000, 0x0000, 0x000F,   9,  11, 0}, {'S', 'S', 0x000E, 0x800F, 0x0000, 0x0000, 0x000F,   9,  11, 0}, {'U', 'U', 0x0069, 0x0000, 0x0000, 0x0000, 0x000F,   9,  11, 0}}},
        {0x0CF, {{'N', 'N', 0x0000, 0x0000, 0x0200, 0x1000, 0x000F,  12,  15, 0}, {'S', 'S', 0x0009, 0x0000, 0x0000, 0x0000, 0x000F,  12,  15, 0}, {'U', 'U', 0x006A, 0x0000, 0x0000, 0x0000, 0x000F,  12,  15, 0}}},
        {0x0D0, {{'N', 'N', 0x0000, 0x0000, 0x0100, 0x0800, 0x000F,   2,   3, 0}, {'S', 'S', 0x0008, 0x0000, 0x0000, 0x0000, 0x000F,   2,   3, 0}, {'U', 'U', 0x006B, 0x0000, 0x0000, 0x0000, 0x000F,   2,   3, 0}}},
        {0x0D1, {{'N', 'N', 0x0000, 0x0000, 0x0100, 0x0800, 0x000B,   5,   6, 0}, {'U', 'U', 0x006C, 0x0000, 0x0000, 0x0000, 0x000B,   5,   6, 0}}},
        {0x0D2, {{'N', 'N', 0x0000, 0x0000, 0x0100, 0x0800, 0x000F,   8,   9, 0}, {'S', 'S', 0x0001, 0x0000, 0x0000, 0x0000, 0x000F,   8,   9, 0}, {'U', 'U', 0x006D, 0x0000, 0x0000, 0x0000, 0x000F,   8,   9, 0}}},
        {0x0D3, {{'N', 'N', 0x0000, 0x0000, 0x0100, 0x0800, 0x000F,   9,  11, 0}, {'S', 'S', 0x0005, 0x0000, 0x0000, 0x0000, 0x000F,   9,  11, 0}, {'U', 'U', 0x006E, 0x0000, 0x0000, 0x0000, 0x000F,   9,  11, 0}}},
        {0x0D4, {{'N', 'N', 0x0000, 0x0000, 0x0100, 0x0800, 0x000F,  12,  15, 0}, {'S', 'S', 0x0009, 0x0000, 0x0000, 0x0000, 0x000F,  12,  15, 0}, {'U', 'U', 0x006F, 0x0000, 0x0000, 0x0000, 0x000F,  12,  15, 0}}},
        {0x0D5, {{'N', 'N', 0x0000, 0x0000, 0x0400, 0x2000, 0x000F,   2,   2, 0}, {'S', 'S', 0x000C, 0x0000, 0x0000, 0x0000, 0x000F,   2,   2, 0}, {'U', 'U', 0x0070, 0x0000, 0x0000, 0x0000, 0x000F,   2,   2, 0}}},
        {0x0D6, {{'N', 'N', 0x0000, 0x0000, 0x0400, 0x2000, 0x000F,   3,   3, 0}, {'S', 'S', 0x000E, 0x0000, 0x0000, 0x0000, 0x000F,   3,   3, 0}, {'U', 'U', 0x0071, 0x0000, 0x0000, 0x0000, 0x000F,   3,   3, 0}}},
        {0x0D7, {{'N', 'N', 0x0000, 0x0000, 0x0400, 0x2000, 0x000F,   5,   5, 0}, {'S', 'S', 0x0001, 0x0000, 0x0000, 0x0000, 0x000F,   5,   5, 0}, {'U', 'U', 0x0072, 0x0000, 0x0000, 0x0000, 0x000F,   5,   5, 0}}},
        {0x0D8, {{'N', 'N', 0x0000, 0x0000, 0x0400, 0x2000, 0x000F,   6,   6, 0}, {'S', 'S', 0x0003, 0x07F0, 0x0000, 0x0000, 0x000F,   6,   6, 0}, {'S', 'S', 0x000A, 0xF80F, 0x0000, 0x0000, 0x000F,   6,   6, 0}, {'U', 'U', 0x0073, 0x0000, 0x0000, 0x0000, 0x000F,   6,   6, 0}}},
        {0x0D9, {{'N', 'N', 0x0000, 0x0000, 0x0400, 0x2000, 0x000F,   8,  11, 0}, {'S', 'S', 0x0009, 0x0000, 0x0000, 0x0000, 0x000F,   8,  11, 0}, {'U', 'U', 0x0074, 0x0000, 0x0000, 0x0000, 0x000F,   8,  11, 0}}},
        {0x0DA, {{'N', 'N', 0x0000, 0x0000, 0x0001, 0x0002, 0x000F,  33,  36, 0}, {'S', 'S', 0x0008, 0x0000, 0x0000, 0x0000, 0x000F,  33,  36, 0}, {'U', 'U', 0x004B, 0x0000, 0x0000, 0x0000, 0x000F,  33,  36, 0}}},
        {0x0DB, {{'N', 'N', 0x0000, 0x0000, 0x0004, 0x0004, 0x000B,  10,  30, 0}, {'U', 'U', 0x0061, 0x0000, 0x0000, 0x0000, 0x000B,  10,  30, 0}}},
        {0x0DC, {{'N', 'N', 0x0000, 0x0000, 0x0004, 0x0004, 0x000B,  15,  25, 0}, {'U', 'U', 0x0062, 0x0000, 0x0000, 0x0000, 0x000B,  15,  25, 0}}},
        {0x0DD, {{'E', 'N', 0x0000, 0x0000, 0x0001, 0x0002, 0x0003,  45,  53, 2}}},
        {0x0DE, {{'E', 'N', 0x0000, 0x0000, 0x0001, 0x0002, 0x0003,  52,  62, 2}}},
        {0x0DF, {{'E', 'N', 0x0000, 0x0000, 0x0001, 0x0002, 0x0003,  63,  72, 2}}},
        {0x0E0, {{'E', 'N', 0x0000, 0x0000, 0x0001, 0x0002, 0x0003,  75,  84, 2}}},
        {0x0E1, {{'E', 'N', 0x0000, 0x0000, 0x0001, 0x0002, 0x0003,  85,  98, 2}}},
        {0x0E2, {{'E', 'N', 0x0000, 0x0000, 0x0001, 0x0002, 0x0003,  78, 113, 2}}},
        {0x0E3, {{'E', 'N', 0x0000, 0x0000, 0x0001, 0x0002, 0x0003,  54,  86, 2}}},
        {0x0E4, {{'E', 'N', 0x0000, 0x0000, 0x0001, 0x0001, 0x0003, 102, 117, 0}}},
        {0x0E5, {{'E', 'N', 0x0000, 0x0000, 0x0001, 0x0001, 0x0003, 111, 126, 0}}},
        {0x0E6, {{'E', 'N', 0x0000, 0x0000, 0x0001, 0x0001, 0x0003, 122, 136, 0}}},
        {0x0E7, {{'E', 'N', 0x0000, 0x0000, 0x0001, 0x0001, 0x0003, 138, 153, 0}}},
        {0x0E8, {{'E', 'N', 0x0000, 0x0000, 0x0001, 0x0001, 0x0003, 158, 172, 0}}},
        {0x0E9, {{'E', 'N', 0x0000, 0x0000, 0x0001, 0x0001, 0x0003, 176, 190, 0}}},
        {0x0EA, {{'E', 'N', 0x0000, 0x0000, 0x0001, 0x0001, 0x0003, 198, 213, 0}}},
        {0x0EB, {{'E', 'N', 0x0000, 0x0000, 0x0001, 0x0001, 0x0003, 188, 202, 0}}},
        {0x0EC, {{'E', 'N', 0x0000, 0x0000, 0x0001, 0x0001, 0x0003, 225, 243, 0}}},
        {0x0ED, {{'E', 'N', 0x0000, 0x0000, 0x0001, 0x0001, 0x0003, 252, 274, 0}}},
        {0x0EE, {{'E', 'N', 0x0000, 0x0000, 0x0001, 0x0001, 0x0003, 242, 258, 0}}},
        {0x0EF, {{'E', 'N', 0x0000, 0x0000, 0x0001, 0x0001, 0x0003, 282, 303, 0}}},
        {0x0F0, {{'E', 'N', 0x0000, 0x0000, 0x0001, 0x0001, 0x0003, 315, 342, 0}}},
        {0x0F1, {{'E', 'N', 0x0000, 0x0000, 0x0001, 0x0001, 0x0003, 417, 450, 0}}},
        {0x0F2, {{'E', 'N', 0x0000, 0x0000, 0x0001, 0x0001, 0x0003, 225, 261, 0}}},
        {0x0F3, {{'E', 'N', 0x0000, 0x0000, 0x0004, 0x0004, 0x0003,  41,  49, 1}}},
        {0x0F4, {{'E', 'N', 0x0000, 0x0000, 0x0004, 0x0004, 0x0003,  47,  55, 2}}},
        {0x0F5, {{'E', 'N', 0x0000, 0x0000, 0x0004, 0x0004, 0x0003,  53,  61, 3}}},
        {0x0F6, {{'E', 'N', 0x0000, 0x0000, 0x0004, 0x0004, 0x0003,  59,  67, 3}}},
        {0x0F7, {{'E', 'N', 0x0000, 0x0000, 0x0004, 0x0004, 0x0003,  68,  78, 3}}},
        {0x0F8, {{'E', 'N', 0x0000, 0x0000, 0x0004, 0x0004, 0x0003,  80,  93, 3}}},
        {0x0F9, {{'E', 'N', 0x0000, 0x0000, 0x0200, 0x1000, 0x0003,  28,  35, 0}}},
        {0x0FA, {{'E', 'N', 0x0000, 0x0000, 0x0200, 0x1000, 0x0003,  33,  39, 0}}},
        {0x0FB, {{'E', 'N', 0x0000, 0x0000, 0x0200, 0x1000, 0x0003,  37,  44, 0}}},
        {0x0FC, {{'E', 'N', 0x0000, 0x0000, 0x0200, 0x1000, 0x0003,  39,  47, 0}}},
        {0x0FD, {{'E', 'N', 0x0000, 0x0000, 0x0200, 0x1000, 0x0003,  43,  53, 0}}},
        {0x0FE, {{'E', 'N', 0x0000, 0x0000, 0x0100, 0x0800, 0x0003,  28,  35, 0}}},
        {0x0FF, {{'E', 'N', 0x0000, 0x0000, 0x0100, 0x0800, 0x0003,  33,  39, 0}}},
        {0x100, {{'E', 'N', 0x0000, 0x0000, 0x0100, 0x0800, 0x0003,  37,  44, 0}}},
        {0x101, {{'E', 'N', 0x0000, 0x0000, 0x0100, 0x0800, 0x0003,  39,  47, 0}}},
        {0x102, {{'E', 'N', 0x0000, 0x0000, 0x0100, 0x0800, 0x0003,  43,  53, 0}}},
        {0x103, {{'E', 'N', 0x0000, 0x0000, 0x0400, 0x2000, 0x0003,  29,  34, 0}}},
        {0x104, {{'E', 'N', 0x0000, 0x0000, 0x0400, 0x2000, 0x0003,  31,  36, 0}}},
        {0x105, {{'E', 'N', 0x0000, 0x0000, 0x0400, 0x2000, 0x0003,  35,  40, 0}}},
        {0x106, {{'E', 'N', 0x0000, 0x0000, 0x0400, 0x2000, 0x0003,  37,  42, 0}}},
        {0x107, {{'E', 'N', 0x0000, 0x0000, 0x0400, 0x2000, 0x0003,  41,  52, 0}}},
        {0x108, {{'E', 'N', 0x0000, 0x0000, 0x0001, 0x0002, 0x0003,  60, 125, 0}}},
        {0x109, {{'E', 'N', 0x0000, 0x0000, 0x0004, 0x0004, 0x0003,  50, 150, 0}}},
        {0x10A, {{'E', 'N', 0x0000, 0x0000, 0x0004, 0x0004, 0x0003,  58,  78, 0}}},
        {0x10B, {{'Q', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x10C, {{'X', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x10D, {{'X', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x10E, {{'X', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x10F, {{'X', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x110, {{'A', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x111, {{'A', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x112, {{'A', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x113, {{'A', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x114, {{'A', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x115, {{'A', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x116, {{'A', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x117, {{'M', 'M', 0x0000, 0x0000, 0x1000, 0x8000, 0x000E,   0,   0, 0}, {'S', 'S', 0x0000, 0x000E, 0x0000, 0x0000, 0x000E,   0,   0, 0}, {'S', 'S', 0x0003, 0x0030, 0x0000, 0x0000, 0x000E,   0,   0, 0}, {'S', 'S', 0x0005, 0x00C0, 0x0000, 0x0000, 0x000E,   0,   0, 0}, {'S', 'S', 0x0007, 0x0100, 0x0000, 0x0000, 0x000E,   0,   0, 0}, {'S', 'S', 0x0008, 0x3E00, 0x0000, 0x0000, 0x000E,   0,   0, 0}, {'S', 'S', 0x000D, 0xC000, 0x0000, 0x0000, 0x000E,   0,   0, 0}, {'S', 'S', 0x000F, 0x0001, 0x0000, 0x0000, 0x000E,   0,   0, 0}, {'U', 'U', 0x0075, 0x0000, 0x0000, 0x0000, 0x000E,   0,   0, 0}, {'U', 'U', 0x0076, 0x0000, 0x0000, 0x0000, 0x000E,   0,   0, 0}, {'U', 'U', 0x0077, 0x0000, 0x0000, 0x0000, 0x000E,   0,   0, 0}, {'U', 'U', 0x007B, 0x0000, 0x0000, 0x0000, 0x000E,   0,   0, 0}}},
        {0x118, {{'Q', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0001,   0,   0, 0}}},
        {0x119, {{'M', 'M', 0x0000, 0x0000, 0x0800, 0x4000, 0x000E,   0,   0, 0}, {'S', 'S', 0x0007, 0x3F00, 0x0000, 0x0000, 0x000E,   0,   0, 0}, {'S', 'S', 0x000D, 0xC0FF, 0x0000, 0x0000, 0x000E,   0,   0, 0}, {'U', 'U', 0x0078, 0x0000, 0x0000, 0x0000, 0x000E,   0,   0, 0}, {'U', 'U', 0x0079, 0x0000, 0x0000, 0x0000, 0x000E,   0,   0, 0}, {'U', 'U', 0x007A, 0x0000, 0x0000, 0x0000, 0x000E,   0,   0, 0}}},
        {0x11A, {{'X', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x11B, {{'Q', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x11C, {{'Q', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x11D, {{'A', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x11E, {{'A', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x11F, {{'A', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x120, {{'N', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x121, {{'N', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x122, {{'X', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x123, {{'X', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x124, {{'X', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x125, {{'X', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x126, {{'X', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x127, {{'X', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x128, {{'X', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x129, {{'X', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x12A, {{'X', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x12B, {{'X', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x12C, {{'X', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x12D, {{'X', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x12E, {{'A', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x12F, {{'X', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x130, {{'Q', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x131, {{'Q', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x132, {{'Q', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x133, {{'Q', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x134, {{'Q', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x135, {{'Q', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x136, {{'Q', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x137, {{'Q', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x138, {{'Q', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x139, {{'Q', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x13A, {{'Q', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x13B, {{'R', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x13C, {{'G', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x13D, {{'G', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x13E, {{'G', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x13F, {{'G', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x140, {{'G', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x141, {{'G', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x142, {{'G', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x143, {{'G', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x144, {{'G', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x145, {{'G', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x146, {{'G', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x147, {{'G', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x148, {{'G', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x149, {{'G', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x14A, {{'G', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x14B, {{'G', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x14C, {{'G', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x14D, {{'G', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x14E, {{'G', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x14F, {{'G', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x150, {{'G', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x151, {{'G', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x152, {{'G', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x153, {{'G', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x154, {{'G', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x155, {{'G', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x156, {{'G', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x157, {{'G', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x158, {{'G', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x159, {{'G', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x15A, {{'A', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x15B, {{'A', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x15C, {{'A', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x15D, {{'A', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x15E, {{'A', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x15F, {{'A', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x160, {{'A', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x161, {{'A', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x162, {{'A', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x163, {{'A', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x164, {{'G', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x165, {{'G', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x166, {{'G', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x167, {{'G', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}},
        {0x168, {{'G', 'N', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,   0,   0, 0}}}
    };
    ...
    bool generateMagicalAffixesBufferv100(std::uint16_t typeCode, std::uint16_t magicLevel, std::vector<PreSuffixStruct>& prefixes, std::vector<PreSuffixStruct>& suffixes)
    {
        prefixes.clear();
        suffixes.clear();
        ...
        static const std::vector<PreSuffixStruct> prefixInfo = {
            {  2,  4, 102, 0x0705, {{ 16,  20,  30}}},
            {  3,  9, 102, 0x0705, {{ 16,  31,  40}}},
            {  4, 19, 102, 0x0705, {{ 16,  41,  50}}},
            {  5, 25, 102, 0x0705, {{ 16,  51,  65}}},
            {  6, 31, 102, 0x0705, {{ 16,  66,  80}}},
            {  7, 36, 103, 0x0705, {{ 16,  81, 100}}},
            {  8,  7, 103, 0x0004, {{ 35,   1,   1}}},
            {  9, 14, 104, 0x0004, {{ 35,   2,   2}}},
            { 13,  1, 106, 0x00F2, {{ 17,  10,  20}}},
            { 14,  5, 106, 0x20F2, {{ 17,  21,  30}}},
            { 15,  8, 106, 0x00F2, {{ 17,  31,  40}}},
            { 16, 14, 106, 0x00F2, {{ 17,  41,  50}}},
            { 17, 20, 106, 0x00F2, {{ 17,  51,  65}}},
            { 18, 26, 106, 0x0092, {{ 17,  66,  80}}},
            { 19, 32, 107, 0x0092, {{ 17,  81, 100}}},
            { 20,  9, 108, 0x1004, {{114,  10,  10}}},
            { 25, 14, 110, 0x0100, {{ 28,  50,  50}}},
            { 26, 14, 111, 0x3F00, {{ 11,   5,  10}}},
            { 27,  1, 111, 0x1AF2, {{ 19,  10,  20}}},
            { 28,  4, 111, 0x08F2, {{ 19,  21,  40}}},
            { 29,  8, 111, 0x08F2, {{ 19,  41,  60}}},
            { 30, 12, 111, 0x08F2, {{ 19,  61,  80}}},
            { 32, 17, 111, 0x00F2, {{ 19,  81, 100}}},
            { 33, 22, 111, 0x08F2, {{ 19, 101, 120}}},
            { 34, 27, 112, 0x0892, {{ 19, 121, 150}}},
            { 35,  5, 112, 0x00F2, {{ 19,  10,  20}, { 17,  10,  20}}},
            { 36,  9, 112, 0x00F2, {{ 19,  21,  40}, { 17,  21,  30}}},
            { 37, 15, 112, 0x00F2, {{ 19,  41,  60}, { 17,  31,  40}}},
            { 38, 21, 112, 0x00F2, {{ 19,  61,  80}, { 17,  41,  50}}},
            { 39, 25, 112, 0x00F2, {{ 19,  81, 100}, { 17,  51,  65}}},
            { 40, 30, 112, 0x0092, {{ 19, 101, 120}, { 17,  66,  80}}},
            { 41, 35, 113, 0x0092, {{ 19, 121, 150}, { 17,  81, 100}}},
            { 42, 16, 114, 0x0072, {{112,   1,   1}}},
            { 43,  5, 115, 0x3800, {{ 79,  10,  15}}},
            { 49,  1, 116, 0x7F65, {{ 89,   1,   1}}},
            { 50,  6, 117, 0x7F65, {{ 89,   2,   2}}},
            { 53,  3, 118, 0x7C75, {{  9,   1,   5}}},
            { 55,  6, 118, 0x5C74, {{  9,   5,  10}}},
            { 56, 14, 118, 0x5C74, {{  9,  11,  20}}},
            { 57, 37, 118, 0x0303, {{  9,  11,  20}}},
            { 58, 20, 118, 0x5C70, {{  9,  21,  30}}},
            { 59, 24, 118, 0x5870, {{  9,  31,  40}}},
            { 60, 52, 118, 0x0301, {{  9,  31,  40}}},
            { 61, 30, 119, 0x5870, {{  9,  41,  60}}},
            { 64, 27, 120, 0x1000, {{ 39,  15,  25}, { 41,  15,  25}, { 43,  15,  25}, { 45,  15,  25}}},
            { 65, 62, 121, 0x0800, {{ 39,  15,  15}, { 41,  15,  15}, { 43,  15,  15}, { 45,  15,  15}}},
            { 66,  5, 121, 0x7FF5, {{ 43,   5,  10}}},
            { 67, 12, 121, 0x5F75, {{ 43,  11,  20}}},
            { 68, 35, 121, 0x0282, {{ 43,  11,  20}}},
            { 69, 18, 121, 0x5D75, {{ 43,  21,  30}}},
            { 70, 55, 121, 0x0282, {{ 43,  21,  30}}},
            { 72, 25, 121, 0x79E0, {{ 43,  31,  50}}},
            { 75,  5, 122, 0x5FF5, {{ 39,   5,  10}}},
            { 76, 12, 122, 0x5F75, {{ 39,  11,  20}}},
            { 77, 35, 122, 0x0082, {{ 39,  11,  20}}},
            { 78, 18, 122, 0x5D75, {{ 39,  21,  30}}},
            { 79, 55, 122, 0x0282, {{ 39,  21,  30}}},
            { 81, 25, 122, 0x5960, {{ 39,  31,  50}}},
            { 84,  5, 123, 0x5FF5, {{ 41,   5,  10}}},
            { 85, 12, 123, 0x5F75, {{ 41,  11,  20}}},
            { 86, 35, 123, 0x0082, {{ 41,  11,  20}}},
            { 87, 18, 123, 0x5D75, {{ 41,  21,  30}}},
            { 88, 55, 123, 0x0282, {{ 41,  21,  30}}},
            { 90, 25, 123, 0x5D61, {{ 41,  31,  50}}},
            { 93,  5, 124, 0x1FD5, {{ 45,   5,  10}}},
            { 94, 12, 124, 0x1F55, {{ 45,  11,  20}}},
            { 95, 35, 124, 0x08A2, {{ 45,  11,  20}}},
            { 96, 18, 124, 0x1855, {{ 45,  21,  30}}},
            { 97, 55, 124, 0x07A2, {{ 45,  21,  30}}},
            { 99, 25, 124, 0x1810, {{ 45,  31,  50}}},
            {101, 30, 125, 0x1080, {{ 83,   1,   1}}},
            {102, 40, 125, 0x0080, {{ 83,   2,   2}}},
            {103, 90, 126, 0x1000, {{ 83,   2,   2}}},
            {104, 30, 126, 0x1010, {{ 83,   1,   1, 3}}},
            {105, 40, 126, 0x0010, {{ 83,   2,   2, 3}}},
            {106, 90, 127, 0x1000, {{ 83,   2,   2, 3}}},
            {107, 30, 127, 0x1020, {{ 83,   1,   1, 2}}},
            {108, 40, 127, 0x0020, {{ 83,   2,   2, 2}}},
            {109, 90, 128, 0x1000, {{ 83,   2,   2, 2}}},
            {110, 30, 128, 0x5040, {{ 83,   1,   1, 1}}},
            {111, 40, 128, 0x0040, {{ 83,   2,   2, 1}}},
            {112, 90, 129, 0x5000, {{ 83,   2,   2, 1}}},
            {113, 30, 129, 0x1002, {{ 83,   1,   1, 4}}},
            {114, 40, 129, 0x0002, {{ 83,   2,   2, 4}}},
            {115, 90, 130, 0x1000, {{ 83,   2,   2, 4}}},
            {118,  3, 133, 0x0872, {{138,   1,   1}}}
        };

        static const std::vector<PreSuffixStruct> suffixInfo = {
            {  1,  7, 102, 0x1805, {{ 34,   1,   1}}},
            {  2, 18, 102, 0x1800, {{ 34,   2,   2}}},
            {  3, 26, 102, 0x1000, {{ 34,   3,   3}}},
            {  4, 35, 102, 0x3000, {{ 34,   4,   4}}},
            {  5, 35, 102, 0x0000, {{ 34,   4,   4}}},
            {  6,  7, 102, 0x3805, {{ 35,   1,   1}}},
            {  7, 18, 103, 0x1800, {{ 35,   2,   2}}},
            {  8, 26, 103, 0x1000, {{ 35,   3,   3}}},
            {  9, 35, 104, 0x1000, {{ 35,   4,   4}}},
            { 11, 25, 105, 0x0070, {{115,   1,   1}}},
            { 12, 16, 106, 0x0012, {{120, -25, -40}}},
            { 13,  6, 106, 0x0012, {{120, -10, -20}}},
            { 14, 14, 106, 0x0405, {{ 78,   1,   3}}},
            { 15, 21, 106, 0x0405, {{ 78,   2,   6}}},
            { 16,  1, 106, 0x02F2, {{ 19,  10,  10}}},
            { 17,  8, 106, 0x00F2, {{ 19,  20,  20}}},
            { 18, 19, 106, 0x0012, {{ 19,  30,  30}}},
            { 19, 25, 107, 0x0012, {{ 19,  40,  40}}},
            { 20,  1, 108, 0x0004, {{ 20,  10,  10}}},
            { 21, 11, 108, 0x0004, {{ 20,  20,  20}}},
            { 22,  5, 108, 0x5870, {{105,  10,  10}}},
            { 23, 17, 108, 0x4070, {{105,  20,  20}}},
            { 24,  4, 109, 0x00F2, {{ 54,   1,   1}, { 55,   1,   4}, { 56, 125, 125}}},
            { 25, 18, 110, 0x0072, {{ 54,   4,   4}, { 55,   4,  12}, { 56, 150, 150}}},
            { 26, 55, 111, 0x1400, {{ 54,   1,   1}, { 55,   1,   4}, { 56, 125, 125}}},
            { 27, 10, 111, 0x5B04, {{118,   1,   1}}},
            { 28,  4, 111, 0x00F2, {{ 48,   1,   1}, { 49,   2,   6}}},
            { 29, 15, 111, 0x00F2, {{ 48,   2,   2}, { 49,   6,  11}}},
            { 30, 25, 111, 0x00F2, {{ 48,  10,  10}, { 49,  10,  20}}},
            { 31, 40, 111, 0x1A00, {{ 48,   1,   1}, { 49,   2,   6}}},
            { 32,  4, 111, 0x00F2, {{ 50,   1,   1}, { 51,   8,   8}}},
            { 33, 15, 111, 0x00F2, {{ 50,   1,   1}, { 51,  16,  16}}},
            { 34, 25, 112, 0x00F2, {{ 50,   1,   1}, { 51,  32,  32}}},
            { 35, 50, 112, 0x1902, {{ 50,   1,   1}, { 51,   8,   8}}},
            { 36,  1, 112, 0x18F2, {{ 22,   1,   2}}},
            { 37,  4, 112, 0x00F2, {{ 22,   2,   2}}},
            { 38,  7, 112, 0x00F2, {{ 22,   3,   4}}},
            { 39, 11, 112, 0x00F2, {{ 22,   5,   7}}},
            { 40, 14, 112, 0x00F2, {{ 22,   8,  10}}},
            { 41, 19, 113, 0x0092, {{ 22,  11,  14}}},
            { 42, 25, 114, 0x0092, {{ 22,  15,  20}}},
            { 43, 42, 115, 0x1804, {{ 22,   3,   4}}},
            { 44,  2, 115, 0x2082, {{ 21,   1,   1}}},
            { 45,  6, 115, 0x00F2, {{ 21,   2,   2}}},
            { 46, 12, 115, 0x18F2, {{ 21,   3,   3}}},
            { 47, 18, 115, 0x00F2, {{ 21,   4,   5}}},
            { 48, 37, 116, 0x1801, {{ 21,   2,   2}}},
            { 49,  5, 116, 0x00E2, {{ 57,   8,   8}, { 58,  24,  24}, { 59,  75,  75}}},
            { 50, 15, 117, 0x00E2, {{ 57,  16,  16}, { 58,  48,  48}, { 59,  75,  75}}},
            { 51, 25, 117, 0x00E2, {{ 57,  32,  32}, { 58,  72,  72}, { 59, 100, 100}}},
            { 52, 45, 118, 0x1800, {{ 57,   8,   8}, { 58,  24,  24}, { 59,  75,  75}}},
            { 53,  4, 118, 0x3800, {{  2,   1,   1}}},
            { 54,  5, 118, 0x1B90, {{  2,   1,   3}}},
            { 55, 10, 118, 0x1B90, {{  2,   4,   6}}},
            { 56, 45, 118, 0x0405, {{  2,   4,   6}}},
            { 57, 18, 118, 0x1B90, {{  2,   7,  10}}},
            { 58, 22, 118, 0x1090, {{  2,  11,  15}}},
            { 59, 60, 118, 0x0F05, {{  2,  11,  15}}},
            { 60, 30, 118, 0x1280, {{  2,  16,  20}}},
            { 61,  5, 119, 0x2505, {{ 99,  10,  10}}},
            { 62,  9, 119, 0x0505, {{ 99,  20,  20}}},
            { 64, 10, 120, 0x1C10, {{ 74,   3,   3}}},
            { 65, 40, 121, 0x0204, {{ 74,   3,   3}}},
            { 66, 70, 121, 0x01E3, {{ 74,   3,   3}}},
            { 67, 17, 121, 0x1010, {{ 74,   5,   5}}},
            { 68, 55, 121, 0x0C00, {{ 74,   5,   5}}},
            { 69,  9, 121, 0x0062, {{117,   1,   1}}},
            { 71,  2, 121, 0x1800, {{ 79,  40,  60}}},
            { 72, 17, 121, 0x1700, {{ 79,  80, 120}}},
            { 73, 12, 122, 0x7800, {{ 80,  10,  19}}},
            { 74, 16, 122, 0x3300, {{ 80,  20,  35}}},
            { 75,  4, 122, 0x7800, {{  9,   1,   1}}},
            { 76,  5, 122, 0x5870, {{  9,   1,   5}}},
            { 77, 10, 122, 0x5870, {{  9,   6,  10}}},
            { 78, 18, 122, 0x5870, {{  9,  11,  15}}},
            { 79, 22, 122, 0x5070, {{  9,  16,  20}}},
            { 80, 30, 122, 0x5870, {{  9,  21,  30}}},
            { 81,  8, 122, 0x0072, {{ 81,   1,   1}}},
            { 82,  6, 123, 0x7FF5, {{ 89,   1,   1}}},
            { 83, 15, 123, 0x58F0, {{ 89,   3,   3}}},
            { 84, 17, 123, 0x7AF0, {{ 89,   5,   5}}},
            { 85, 23, 123, 0x3405, {{  7,   5,   5}}},
            { 86,  3, 123, 0x3F75, {{  7,   1,   5}}},
            { 87,  6, 123, 0x1F75, {{  7,   5,  10}}},
            { 88, 14, 123, 0x1F75, {{  7,  11,  20}}},
            { 89, 45, 123, 0x0082, {{  7,  11,  20}}},
            { 90, 20, 123, 0x1F05, {{  7,  21,  30}}},
            { 91, 24, 124, 0x1805, {{  7,  31,  40}}},
            { 92, 60, 124, 0x0602, {{  7,  31,  40}}},
            { 93, 30, 124, 0x3405, {{  7,  41,  60}}},
            { 94,  6, 124, 0x18F2, {{ 60,   4,   7}}},
            { 95, 20, 124, 0x0072, {{ 60,   8,  10}}},
            { 96,  6, 124, 0x18F2, {{ 62,   4,   8}}},
            { 97, 20, 124, 0x0072, {{ 62,   9,  12}}},
            { 98, 25, 124, 0x1005, {{110,  75,  75}}},
            { 99, 18, 124, 0x1005, {{110,  50,  50}}},
            {100,  7, 125, 0x1F05, {{110,  25,  25}}},
            {102, 25, 125, 0x0087, {{ 91, -40, -40}}},
            {103, 15, 126, 0x0087, {{ 91, -20, -20}}},
            {105,  5, 126, 0x1C00, {{  0,   1,   3}}},
            {106, 10, 127, 0x3816, {{  0,   4,   6}}},
            {107, 18, 127, 0x1C12, {{  0,   7,  10}}},
            {108, 47, 127, 0x0304, {{  0,   7,  10}}},
            {109, 22, 128, 0x1412, {{  0,  11,  15}}},
            {110, 62, 128, 0x0B04, {{  0,  11,  15}}},
            {111, 30, 128, 0x1500, {{  0,  16,  20}}},
            {112,  2, 129, 0x0100, {{ 96,  10,  10}}},
            {113, 12, 129, 0x0100, {{ 96,  20,  20}}},
            {114, 22, 129, 0x0100, {{ 96,  30,  30}}}
        };
    ...
    bool generateRareOrCraftedAffixesBufferv100(std::uint16_t typeCode, std::vector<int>& prefixes, std::vector<int>& suffixes)
    {
        prefixes.clear();
        suffixes.clear();
        ...
        for (const auto& info : itemInfo)
        {
            ...
            rareMask = info.RareMask;
            break;
        }

        static const std::map<int, int> rarePrefixMasks = {
            {0x009C, 0xFFFF}, {0x009D, 0xFFFF}, {0x009E, 0xFFFF}, {0x009F, 0xFFFF}, {0x00A0, 0xFFFF}, {0x00A1, 0xFFFF}, {0x00A2, 0xFFFF}, {0x00A3, 0xFFFF},
            {0x00A4, 0xFFFF}, {0x00A5, 0xFFFF}, {0x00A6, 0xFFFF}, {0x00A7, 0xFFFF}, {0x00A8, 0xFFFF}, {0x00A9, 0xFFFF}, {0x00AA, 0xFFFF}, {0x00AB, 0xFFFF},
            {0x00AC, 0xFFFF}, {0x00AD, 0xFFFF}, {0x00AE, 0x3B87}, {0x00A9, 0x3FFF}, {0x00B0, 0x3FFF}, {0x00B1, 0x3FFF}, {0x00B2, 0x0380}, {0x00B3, 0x3FFF},
            {0x00B4, 0x3FFF}, {0x00B5, 0x3FFF}, {0x00B6, 0x3FFF}, {0x00B7, 0x3FFF}, {0x00B8, 0x3FFF}, {0x00B9, 0x3FFF}, {0x00BA, 0x3FFF}, {0x00BB, 0x3FFF},
            {0x00BC, 0x3FFF}, {0x00BD, 0x3FFF}, {0x00BE, 0x3FFF}, {0x00BF, 0x3FFF}, {0x00C0, 0x001F}, {0x00C1, 0xFFFF}, {0x00C2, 0xFFFF}, {0x00C3, 0xC000},
            {0x00C4, 0xC000}, {0x00C5, 0x0000}, {0x00C6, 0x0000}, {0x00C7, 0x0000}, {0x00C8, 0x0000}, {0x00C9, 0xC000}
        };

        static const std::map<int, int> rareSuffixMasks = {
                {0x0001, 0x0018}, {0x0002, 0x0048}, {0x0003, 0x0008}, {0x0004, 0x0048}, {0x0005, 0x0048}, {0x0006, 0x0458}, {0x0007, 0x0008}, {0x0008, 0x0018},
                {0x0009, 0x0018}, {0x000A, 0x0008}, {0x000B, 0x0010}, {0x000C, 0x0018}, {0x000D, 0x0018}, {0x000E, 0x0010}, {0x000F, 0x0010}, {0x0010, 0x0010},
                {0x0011, 0x0010}, {0x0012, 0x0010}, {0x0013, 0x0010}, {0x0014, 0x0010}, {0x0015, 0x01A0}, {0x0016, 0x01A0}, {0x0017, 0x01A0}, {0x0018, 0x01A0},
                {0x0019, 0x01A0}, {0x001A, 0x01A0}, {0x001B, 0x01A0}, {0x001C, 0x01A0}, {0x001D, 0x01A0}, {0x001E, 0x01A0}, {0x001F, 0x0040}, {0x0020, 0x0048},
                {0x0021, 0x0048}, {0x0022, 0x0048}, {0x0023, 0x0040}, {0x0024, 0x0040}, {0x0025, 0x0000}, {0x0026, 0x0040}, {0x0027, 0x0048}, {0x0028, 0x0448},
                {0x0029, 0x0440}, {0x002A, 0x0400}, {0x002B, 0x0400}, {0x002C, 0x0400}, {0x002D, 0x0400}, {0x002E, 0x0400}, {0x002F, 0x0402}, {0x0030, 0x0448},
                {0x0031, 0x0400}, {0x0032, 0x0240}, {0x0033, 0x0640}, {0x0034, 0x0200}, {0x0035, 0x0798}, {0x0036, 0x0380}, {0x0037, 0x0380}, {0x0038, 0x0380},
                {0x0039, 0x0380}, {0x003A, 0x0380}, {0x003B, 0x0380}, {0x003C, 0x0002}, {0x003D, 0x0002}, {0x003E, 0x0002}, {0x003F, 0x0002}, {0x0040, 0x0002},
                {0x0041, 0x0002}, {0x0042, 0x0002}, {0x0043, 0x0002}, {0x0044, 0x0002}, {0x0045, 0x0002}, {0x0046, 0x0001}, {0x0047, 0x0001}, {0x0048, 0x0001},
                {0x0049, 0x0001}, {0x004A, 0x0001}, {0x004B, 0x0001}, {0x004C, 0x0001}, {0x004D, 0x0001}, {0x004E, 0x0001}, {0x004F, 0x0001}, {0x0050, 0x0004},
                {0x0051, 0x0004}, {0x0052, 0x0004}, {0x0053, 0x0004}, {0x0054, 0x0004}, {0x0055, 0x0004}, {0x0056, 0x0004}, {0x0057, 0x0004}, {0x0058, 0x0004},
                {0x0059, 0x0004}, {0x005A, 0x1000}, {0x005B, 0x1000}, {0x005C, 0x1000}, {0x005D, 0x1000}, {0x005E, 0x5000}, {0x005F, 0x5000}, {0x0060, 0x5000},
                {0x0061, 0x5000}, {0x0062, 0x5000}, {0x0063, 0x5000}, {0x0064, 0x0800}, {0x0065, 0x0800}, {0x0066, 0x0800}, {0x0067, 0x0800}, {0x0068, 0x0800},
                {0x0069, 0x0800}, {0x006A, 0x0840}, {0x006B, 0x0800}, {0x006C, 0x0800}, {0x006D, 0x0800}, {0x006E, 0x0800}, {0x006F, 0x2000}, {0x0070, 0x2000},
                {0x0071, 0x2000}, {0x0072, 0x2000}, {0x0073, 0x2000}, {0x0074, 0x2000}, {0x0075, 0x2000}, {0x0076, 0x2000}, {0x0077, 0x2000}, {0x0078, 0x2000},
                {0x0079, 0x4000}, {0x007A, 0x4000}, {0x007B, 0x4000}, {0x007C, 0x4000}, {0x007D, 0x4000}, {0x007E, 0x4000}, {0x007F, 0x4000}, {0x0080, 0x4000},
                {0x0081, 0x4000}, {0x0082, 0x4000}, {0x0083, 0x8000}, {0x0084, 0x8000}, {0x0085, 0x8000}, {0x0086, 0x8000}, {0x0087, 0x8000}, {0x0088, 0x8000},
                {0x0089, 0x8000}, {0x008A, 0x8000}, {0x008B, 0x8000}, {0x008C, 0x0340}, {0x008D, 0x03F8}, {0x008E, 0x03A0}, {0x008F, 0x03A0}, {0x0090, 0x0400},
                {0x0091, 0x0400}, {0x0092, 0xC000}, {0x0093, 0x03E0}, {0x0094, 0x0018}, {0x0095, 0x0200}, {0x0096, 0x0078}, {0x0097, 0x0007}, {0x0098, 0x0040},
                {0x0099, 0x0040}, {0x009A, 0x0040}, {0x009B, 0x00A1}
        };

        for (auto& prefix : rarePrefixMasks)
        {
            if ((prefix.second & rareMask) == 0)
            {
                continue;
            }

            prefixes.push_back(prefix.first);
        }

        for (auto& suffix : rareSuffixMasks)
        {
            if ((suffix.second & rareMask) == 0)
            {
                continue;
            }

            suffixes.push_back(suffix.first);
        }
        return true;
    }

    void processMagicalProperites(const std::vector<ModStruct>& mods, std::vector<MagicalAttribute>& magicalAttributes, ItemRandStruct& rnd)
    {
        std::uint16_t nextInChain = 0;
        size_t numRndCalls = mods.size();
        for (auto& mod : mods)
        {
            ...
            {
                magicalAttributes.back().Values.push_back(attrib.Values.front());
                nextInChain = 0;
...
std::uint16_t d2ce::ItemHelpers::getTypeCodev100(const std::array<std::uint8_t, 4>& strcode)
{
    static const std::map<std::string, int> itemCodes = {
        ...
        {"tsc", 0x120}, {"isc", 0x121}, {"hrt", 0x122}, {"brz", 0x123}, {"jaw", 0x124}, {"eyz", 0x125}, {"hrn", 0x126}, {"tal", 0x127},
        {"flg", 0x128}, {"fng", 0x129}, {"qll", 0x12A}, {"sol", 0x12B}, {"scz", 0x12C}, {"spe", 0x12D}, {"key", 0x12E}, {"luv", 0x12F},
...
//---------------------------------------------------------------------------
std::uint8_t d2ce::ItemHelpers::getMaxSocketsv100(const std::array<std::uint8_t, 4>& strcode)
{
    const auto& itemInfo = getItemV100Info(ItemHelpers::getTypeCodev100(strcode));
    if (itemInfo.empty())
    {
        return 0ui8;
    }

    return std::uint8_t(itemInfo.front().Sockets);
}
//---------------------------------------------------------------------------
bool d2ce::ItemHelpers::getItemCodev100(std::uint16_t code, std::array<std::uint8_t, 4>& strcode)
{
    static const std::map<int, std::string> typeCodes = {
        ...
        {0x120, "tsc"}, {0x121, "isc"}, {0x122, "hrt"}, {0x123, "brz"}, {0x124, "jaw"}, {0x125, "eyz"}, {0x126, "hrn"}, {0x127, "tal"},
        {0x128, "flg"}, {0x129, "fng"}, {0x12A, "qll"}, {0x12B, "sol"}, {0x12C, "scz"}, {0x12D, "spe"}, {0x12E, "key"}, {0x12F, "luv"},
...
bool d2ce::ItemHelpers::generateMagicalAffixesv100(std::uint16_t typeCode, std::uint32_t dwb, std::uint16_t magicLevel, MagicalCachev100& cache)
{
    ...
    if (!generateMagicalAffixesBufferv100(typeCode, magicLevel, prefixes, suffixes))
    {
        return false;
    }
    ...
    if ((generateRandomv100(rnd) % 2) == 1)
    {
        ...
        processMagicalProperites(prefix.mod, cache.MagicalAttributes, rnd);
    }
    ...
    if ((generateRandomv100(rnd) % 2) == 1 || (cache.Affixes.PrefixId == 0))
    {
        ...
        processMagicalProperites(suffix.mod, cache.MagicalAttributes, rnd);
    }

    return true;
}
//---------------------------------------------------------------------------
bool d2ce::ItemHelpers::generateRareOrCraftedAffixesv100(std::uint16_t typeCode, std::uint32_t dwb, std::uint16_t magicLevel, RareOrCraftedCachev100& cache)
{
    std::vector<PreSuffixStruct> prefixes;
    std::vector<PreSuffixStruct> suffixes;
    if (!generateMagicalAffixesBufferv100(typeCode, magicLevel, prefixes, suffixes))
    ...
    std::vector<int> rarePrefixes;
    std::vector<int> rareSuffixes;
    if (!generateRareOrCraftedAffixesBufferv100(typeCode, rarePrefixes, rareSuffixes))
    {
        return false;
    }
    ...
    cache.Id = std::uint16_t(rarePrefixes[generateRandomv100(rnd) % rarePrefixes.size()]);
    cache.Name = ItemHelpers::getRareNameFromId(cache.Id);
    cache.Id2 = std::uint16_t(rareSuffixes[generateRandomv100(rnd) % rareSuffixes.size()]);
    cache.Name2 = ItemHelpers::getRareNameFromId(cache.Id2);

    std::uint32_t nTotalPreSuffixes = (generateRandomv100(rnd) % 3) + 4;
    std::uint32_t nPrefixes = 0;
    std::uint32_t nSuffixes = 0;
    std::uint32_t infiniteGuard = 1000000; // no more loops then this
    std::vector<PreSuffixStruct> curPreSuffix;
    std::vector<bool> isPrefix;
    for (size_t nCurPreSuffix = 0; nCurPreSuffix < nTotalPreSuffixes; ++nCurPreSuffix)
    {
        // Do we have a prefix?
        auto PreSuf = generateRandomv100(rnd) % 2;
        generateRandomv100(rnd); // skip the next random number
        if ((PreSuf == 0 && nPrefixes < 3) || (nSuffixes > 2))
        {
            ...
            while (!bDone)
            {
                ...
                idx = generateRandomv100(rnd) % prefixes.size();
                bDone = true;
        ...
        else
        {
            ...
            while (!bDone)
            {
                ...
                idx = generateRandomv100(rnd) % suffixes.size();
                bDone = true;
                for (auto iter = curPreSuffix.rbegin(); iter != curPreSuffix.rend(); ++iter)
                {
    ...
    for (auto iter = curPreSuffix.begin(); iter != curPreSuffix.end() && iterIsPrefix != isPrefix.end(); ++iter, ++iterIsPrefix)
    {
        if (*iterIsPrefix)
        {
            ...
            affixItem.Affixes.PrefixId = std::uint16_t(iter->code);
            affixItem.Affixes.PrefixName = ItemHelpers::getMagicalPrefixFromId(affixItem.Affixes.PrefixId);
            if (affixItem.Affixes.SuffixId == MAXUINT16)
            {
                affixItem.Affixes.SuffixId = 0;
            }

            processMagicalProperites(iter->mod, affixItem.MagicalAttributes, rnd);
        }
        else
        {
            ...
            affixItem.Affixes.SuffixId = std::uint16_t(iter->code);
            affixItem.Affixes.SuffixName = ItemHelpers::getMagicalSuffixFromId(affixItem.Affixes.SuffixId);
...
//---------------------------------------------------------------------------
std::uint8_t d2ce::ItemHelpers::generateDefenseRatingv100(const std::array<std::uint8_t, 4>& strcode, std::uint32_t dwa)
{
    if (dwa == 0)
    {
        return 0;
    ...
    const auto& itemInfo = getItemV100Info(typeCode);
    const auto& info = itemInfo.front(); // Doesn't matter which one
    if (info.ACMax > info.ACMin)
    {
        return std::uint8_t(generateDWARandomOffsetv100(dwa, 2) % (info.ACMax - info.ACMin) + info.ACMin);
    }

    return std::uint8_t(info.ACMin);
}
//---------------------------------------------------------------------------
...
std::uint16_t d2ce::ItemHelpers::getIdFromRareName(const std::string& rareName)
{
    static const std::map<std::string, int> rareNames = {
            ...
            {"Hold", 0x060}, {"Touch", 0x061}, {"Finger", 0x062}, {"Knuckle", 0x063}, {"Shank", 0x064}, {"Spur", 0x065}, {"Tread", 0x066}, {"Stalker", 0x067},
            ...
            {"Loom", 0x090}, {"Harp", 0x091}, {"Master", 0x092}, {"Barri", 0x093}, {"Hew", 0x094}, {"Crook", 0x095}, {"Mar", 0x096}, {"Shell", 0x097},
            ...
            {"Demon", 0x0B0}, {"Cruel", 0x0B1}, {"Empyrian", 0x0B2}, {"Bramble", 0x0B3}, {"Pain", 0x0B4}, {"Loath", 0x0B5}, {"Glyph", 0x0B6}, {"Imp", 0x0B7},
            {"Fiend", 0x0B8}, {"Hailstone", 0x0B9}, {"Gale", 0x0BA}, {"Dire", 0x0BB}, {"Soul", 0x0BC}, {"Brimstone", 0x0BD}, {"Corpse", 0x0BE}, {"Carrion", 0x0BF},
